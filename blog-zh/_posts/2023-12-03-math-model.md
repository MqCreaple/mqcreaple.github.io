...
![desmos](/img/blog/2023-12-03/himcm-screenshot-3.png)
...
1. 像游戏《都市天际线》那样，给每一辆车一个尽可能精确的行为逻辑，然后在城市地图上放几千辆车来看最终的模拟结果。
   ![cities-skylines-traffic](/img/blog/2023-12-03/cities-skylines-Traffic_Info_View_SS.png)
2. 只考虑某一路段的一定数量的车，假定这段路被分成了许多离散的格点，并且每辆车在每个时刻都只能在某一个格点上。定义一套格点状态演化的规则，观察在不同的规则下会有什么样的结果。
   ![traffic-map](/img/blog/2023-12-03/modeling-traffic-velocity-map-130.png)
...
![traffic-p-0.2](/img/blog/2023-12-03/modeling-traffic-velocity-map-45-0.2.png)
*图1：200路长，42辆车，每辆车每个时刻有0.2的概率减速*

可以看到上述图像中有一处堵车随着时间推移就逐渐消失了。

![traffic-p-0](/img/blog/2023-12-03/modeling-traffic-velocity-map-45-0.png)
