...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);hljs.registerLanguage("groovy",(()=>{"use strict";function e(e,n={}){
...
excludeBegin:!0,end:a+":",relevance:0}],illegal:/#|<\//};var l}})());hljs.registerLanguage("ruby",(()=>{"use strict";function e(e){
...
aliases:["yml"],contains:b}}})());hljs.registerLanguage("dos",(()=>{"use strict";return e=>{
...
className:"number",begin:"\\b\\d+",relevance:0},t]}}})());hljs.registerLanguage("autohotkey",(()=>{"use strict";return e=>{const a={
...
begin:"A_[a-zA-Z0-9]+"},{begin:",\\s*,"}]}}})());hljs.registerLanguage("javascript",(()=>{"use strict"
...
},n]}}})());hljs.registerLanguage("r",(()=>{"use strict";function e(...e){return"("+((e=>{
...
end:/$/,keywords:{$pattern:/[\.\w]+/,keyword:".PHONY"}},r]}}})());hljs.registerLanguage("lisp",(()=>{"use strict";return e=>{
...
},{className:"literal",begin:/(-)[\w\d]+/,relevance:0}]},m)}}})());hljs.registerLanguage("diff",(()=>{"use strict";function e(...e){
...
className:"meta",begin:/^[\t ]*@/,end:/(?=#)|$/,contains:[b,p,o]}]}}})());hljs.registerLanguage("scilab",(()=>{"use strict";return e=>{
...
end:"\\][\\.']*",relevance:0,contains:n},e.COMMENT("//","$")].concat(n)}}})());hljs.registerLanguage("basic",(()=>{"use strict";return E=>({name:"BASIC",
...
className:"number",begin:"(&[oO][0-7]{1,6})"}]})})());hljs.registerLanguage("julia",(()=>{"use strict";return e=>{
...
relevance:0}]}}})());hljs.registerLanguage("prolog",(()=>{"use strict";return n=>{const e={
...
contains:g.concat([{begin:/\.$/}])}}})());hljs.registerLanguage("scala",(()=>{"use strict";return e=>{const n={
...
begin:"\\b("+e.join("|")+")\\b"}]};var s}})());hljs.registerLanguage("gradle",(()=>{"use strict";return e=>({name:"Gradle",
case_insensitive:!0,
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},b]}}})());hljs.registerLanguage("julia-repl",(()=>{"use strict";return a=>({
name:"Julia REPL",contains:[{className:"meta",begin:/^julia>/,relevance:10,
starts:{end:/^(?![ ]{6})/,subLanguage:"julia"},aliases:["jldoctest"]}]})})());hljs.registerLanguage("shell",(()=>{"use strict";return s=>({
