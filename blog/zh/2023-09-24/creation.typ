...
如果把“创新”当作是在许多种不同的路径中根据自身的能力、喜好、经历来挑选出一条路径，那么“发现”和“发明”的区别就是：一个_发现_
...
而提出一个抽象的数学结构则除了严密的逻辑，还需要一定的抽象思维。_抽象思维_指的是能够从许多不同的事物中提取出相同的部分，并将这些相同部分总结成规律的能力。例如19世纪由阿贝尔提出的群论就是这样的：由于许多运算都具有结合律、单位元、逆元这三个性质，这三个性质被归纳成了一个抽象的概念“群”，而有关“群”的定理就可以应用到任何具有“群”的性质的运算上。类似的，“向量空间”、“拓扑空间”、“测度”等数学概念都属于对具体数学问题的抽象。
...
社会科学就是研究“人类社会”这个对象的科学。和复杂系统类似，任何社会科学的研究都只可能关注到社会中的一小部分，再加上人际关系之间更具有主观成分，因此个人的喜好和经历的不同可能会让针对类似现象的社会学的研究得出不尽相同的结论。社会科学里面的经济、历史等需要量化和有具体目标的学科创新在数轴靠左，而政治、文化、文学等研究则在数轴靠右。
