...
昨天我在刷 YouTube 的时候看到了某位叫 #link("https://www.youtube.com/@SubAnima")[SubAnima] 的 up。他的视频讲的都是大多数人在高中课内就学过的生物知识，比如遗传学和 DNA 的结构，但是他详细地解释了这些知识的来源以及所谓的“知识”和现实世界的差距。在 SubAnima 的视频里你会明白，原来绝大部分课本上的生物学知识都和现实世界相差甚远。

比如说遗传学，在这个#link("https://www.youtube.com/watch?v=zpIqQ0pGs1E")[视频]中他解释了孟德尔的遗传学定律的来源：其实孟德尔的遗传学定律只在极其特殊的条件下才会成立。例如在后人复刻的孟德尔的实验中，豌豆茎的高度以及豌豆的颜色都不是非高即矮、非绿即黄的二元变量，而是在高和矮、绿和黄之间的一个连续变化的变量；而孟德尔之所以能得到他的遗传学定律也只是出于偶然：他作为一个园艺家，在花费了两年多的时间来筛选出一批自然界中极难出现的、完全纯种的绿色和黄色豌豆来进行的实验，在杂交了两代之后才观察到了我们熟知的遗传学定律。而后人将它的定律应用到更多不同的性状上，比如瞳孔颜色、发色等，认为所有性状都只有显性和隐性两种类型，并且将某个假想的“生命因子”（即后来被发现的 DNA）一一对应到每一个性状上，这些都是对孟德尔的遗传定律的误用。
...
而大部分通过“过度简化”而发现的定律则不像上面例子中的几个定律那样幸运了，许多最终被证明不够普适的定律最终都沦为了“经验法则”。因此，现代科学基石的几个定律可以说其实都是运气的产物，只是这些定律的应用范围恰好都比较广而已。在 wikipedia 上面甚至有一个词叫 #link("https://en.wikipedia.org/wiki/Physics_envy")[physics envy（物理嫉妒）]，指的是其他自然和社会科学分支嫉妒物理学“拥有像牛顿定律、相对论、量子力学”这样的简洁且普适的定律。现在这个现象已经扩展到了物理学内部，在环境科学、材料科学等更加复杂的物理学里面也很难找到普适定律了。
...
科学革命和后来的工业革命带来的一个延续到现在的思维误区就是：认为世界上的一切事物都像机器那样拥有_唯一确定的功能\/目的_，以及_可以被分解成能够被人理解的子部分_。而在这个思维上继续延伸的话，你可能会得到*机械唯物主义*，即整个宇宙就是一个大机器，遵循着某个确定的_基本原理_一步一步地演化，而所有事物都可以被拆分成具有确定功能的部件。但是真实的世界并不是这样的。

在 SubAnima 的视频“#link("https://www.youtube.com/watch?v=oDG_7Ame0m0")[Could There Be Laws Of Biology?]”里面，作者就探讨了“细胞”究竟是不是一个机器。这里非常推荐有高中生物基础并且想要从事科学研究的朋友们仔细看一下他的视频，里面澄清了许多曾经科学家对细胞的误解。你会发现真实世界里的任何过程其实都是非常复杂、非常难以描述的。生命过程不像是机械，它其中包含了大量错综复杂的过程，你根本无法定义出到底一个蛋白质或者一种分子在这个复杂过程中的“目的”和“功能”到底是什么。
