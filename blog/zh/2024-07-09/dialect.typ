...
这次暑假，我再度回到了成都，再度参观了洛带古镇。这次古镇旁边的客家土楼翻新完成了，二层还建了一个客家文化和历史的博物馆，挺有意思的。#link("/zh/posts/2024-01-09/dialect/")[前情回顾]。
...
#html.frame[
  #diagram(
    ...
    node((2, 0), [商户]),
    node((4, 0), [房东]),
    edge((0, 0), (2, 0), "->", label: [钱]),
    edge((2, 0), (0, 0), "->", label: [零售、娱乐等]),
    edge((2, 0), (4, 0), "->", label: [房租]),
    edge((4, 0), (2, 0), "->", label: [场地]),
  )
]
...
55岁以上的洛带居民大多是在土地上生活了一辈子的农民。正如费孝通先生在《乡土中国》中观察到的那样 @cite1，农村的生活是稳定的、一眼能望到头的，农村人不需要太多和外界的交流。农民不会轻易地离开自己的土地，他们的日常交流几乎只局限于自己的同乡人。同一个村子的人的语言从此相互影响，让洛带独特的乡音代代相传。
