// title: 普通话的时代，方言何去何从？
// summary: 以洛带地区客家话为例，分析普通话推广对方言的影响。
...
#figure(supplement: [假设], caption: none)[
#quote(block: true)[
...
现实生活中这个问题的答案因人而异，并且有许多不同的因素会影响一个人对第二外语的选择。但在这里，我们将模型简化一下，仅考虑两个影响因素：_外语与母语的相似程度_、_外语的影响力_。

- 若一个外语与某人的母语越相似，那么这个人就可以花更少的时间和精力去学习这门语言。
- 若一个外语的影响力越大，那么这个人学会这门外语之后就能和更多人交流，给自己带来更大的回报。

若只考虑这两个因素，并且根据之前的 @fig:hypothesis-3，一个合理的推论就是：如果一个语言A在学习难度或者影响力这两个指标上都不如另一个语言B，那么A就不值得作为一个外语去学习。
...
_方言之间的相似度数据来自_ @cite3

那么根据刚刚的推论，在这个例子里面，由于广东话和上海话在你所处环境的影响力都不如杭州话，且这两个方言与闽南语的距离都比杭州话远，因此这两个语言就不如杭州话值得学习。也就是说，在这个表格里值得作为第二语言学习的只有两个：_杭州话_和_普通话_。
...
根据 @fig:hypothesis-4，似乎影响力小的语言必然会朝着影响力大的语言合并，这看起来很悲观，但现实是已经有许多影响力小的语言被影响力大的语言替代或者被同化了。例如在英语的影响下，即使没有强力执行单一语言政策，许多美国原住民的语言在上个世纪已经濒危或消失了。在国内的大城市里，许多曾经的方言发音也逐渐向普通话靠拢，例如B站up#link("https://space.bilibili.com/40734689")[小白的二次元]中介绍的成都新老发音对比。

当然需要注意的是，这几个假设并不完全与实际相符，比如我们并没有考虑语言的代际传递。一个孩子在从长辈学习一门语言的时候，有可能习得的发音、词语、语法规则等等都和长辈使用的词语和语法略有差别。这样的差别在一代以内可能不太明显，但随着时间的积累，即使同一门语言也会逐渐演变和分化。这和生物的繁殖、演化、分化很像。我也找到了一些用数学建模的方法研究语言演化的论文，可以看这里：@cite2。
...
龙泉驿区虽然距离成都市中心仅约30公里的路程，但是两地的方言有许多的不同。成都市中心以及成都大部分郊区的方言都是成都话，隶属于*官话*中的*西南官话*分支，但是由于龙泉驿附近的大部分居民都是在清朝初年的#link("https://zh.wikipedia.org/wiki/%E6%B9%96%E5%B9%BF%E5%A1%AB%E5%9B%9B%E5%B7%9D")[湖广填四川]来到成都的客家人，所以目前龙泉驿附近主流的方言是属于*客家话*下的*四川客家话*分支，在本地也叫*土广东话*。这点在#link("https://zhongguoyuyan.cn/index")[中国语言资源保护工程采录展示平台]有详细介绍，#link("https://zh.wikipedia.org/wiki/%E5%9B%9B%E5%B7%9D%E5%AE%A2%E5%AE%B6%E8%A9%B1")[维基百科]上也有对应的文档，在这里就不赘述了。
...
_湖广会馆：湖广填四川后，湖广会馆作为从湖广地区来的同乡人的社交和议事场所_

龙泉驿区属于是巴蜀地区的一个客家话#link("https://zh.wikipedia.org/wiki/%E8%AF%AD%E8%A8%80%E5%B2%9B")[方言岛]。出于日益增长的交流需要，现在大部分龙泉驿本地人都会说两种方言——客家话和成都话，能流利使用普通话的人数也在不断增加。在龙泉驿最著名的景点——洛带古镇，由于面对来自全国各地的游客，景点附近的工作人员几乎都会普通话、成都话、客家话这三种方言。因此可见，在旅游景区附近，三个方言按照影响力排序就是：*普通话 > 成都话 > 四川客家话*。

#image("洛带古镇.jpeg", width: 70%)

_洛带古镇_

自从客家人迁至龙泉驿以来，他们使用的语言就从未停止演化。我采访了一些旅游景区附近的本地人，询问了部分字词在本地方言的说法，并且在征得采访者同意的条件下录音备份。与#link("https://www.wiktionary.org/")[Wiktionary]上给出的梅县客家话读音对比结果如下：
...
如果是第一派，那么你应该会希望通过建立详细档案来保存一个语言。曾经在我们没有录音、录像设备的时候只能通过编写字典来记录一个语言的文字，而现在我们还可以记录语音、视频等更加全面的信息。目前世界各地的语言机构已经建立了许多这样的档案，比如你可以在#link("https://zhongguoyuyan.cn/")[中国语言资源保护工程采录展示平台]看到中国详细到每个城市、每个地区的方言。只要关于一个语言的档案足够详细，后世的人就可以根据这个档案重新学会这门语言。
