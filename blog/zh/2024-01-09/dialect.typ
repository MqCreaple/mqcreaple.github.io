...
若只考虑这两个因素，并且根据之前的 @hypothesis-3，一个合理的推论就是：如果一个语言A在学习难度或者影响力这两个指标上都不如另一个语言B，那么A就不值得作为一个外语去学习。
...
根据 @hypothesis-4，似乎影响力小的语言必然会朝着影响力大的语言合并，这看起来很悲观，但现实是已经有许多影响力小的语言被影响力大的语言替代或者被同化了。例如在英语的影响下，即使没有强力执行单一语言政策，许多美国原住民的语言在上个世纪已经濒危或消失了。在国内的大城市里，许多曾经的方言发音也逐渐向普通话靠拢，例如B站up#link("https://space.bilibili.com/40734689")[小白的二次元]中介绍的成都新老发音对比。
