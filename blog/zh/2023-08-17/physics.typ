...
可以看出，感官并不是万能的。在没有理论的指导下，仅靠感官无法获得这个世界的本质。感官无法感知到只存在于逻辑世界中的概念。
...
抛开这些结论在现实世界中的正确性不谈#strike[（关于因果律、经验法则等定律是否真实存在、还是仅仅是人类的某个幻想，这也是曾经的哲学家争论过很久的问题）]，依靠这些逻辑学和数学工具，我们将过去发现的定理应用到未来，做出预测，进行试验，通过实验结果修正定理，最终逐步搭建起了现代的自然科学的大厦。至少在现在，我们还没有找到逻辑、数学与自然科学之间相互矛盾的地方，或许这条路在以后也可以接着走下去。但是，作为一个人类个体，学习这些数学和科学理论所需要的成本在不断地增加。

对于一个普通的人类，想要从刚接触这个物理世界到学习完目前物理学最深刻、最有可能接近世界本质的理论——超弦理论，它需要经历25\~30年的教育。这其中的投入是巨大的。而在当今的时代，社会的诸多领域里人类的智能已经表现出它的局限性了，人造的机器已经不仅在力量上，而且在智力上也远远超出了人类。或许100年前的人类都无法想到一个机器能够学习全人类所有的文字，并且能和你通过日常语言来对话。如果将现在的发展趋势推测到未来，可能不久的将来，世界上就会出现专门用于学习复杂数学结构和数学定理的 AI（从而能够更好地理解世界的底层逻辑），到那时候，计算机只需要源源不断的电力就可以不断的产出人类穷尽一生都无法理解的数学定理。

而即便我们探知到了这个世界最本质的物理定律，它能够对我们的日常生活有影响吗？或许也不会，因为这个由物质构成的世界中的复杂因素太多了。在简单的系统中，例如机械工程和电子工程，或许使用物理学定律进行计算能够得出非常接近真实世界的模型；但是在更加复杂的系统里，例如对蛋白质空间结构的预测，因为里面的影响变量太多，由物理学定律计算出的结果甚至比不过仅靠大数据训练出的 AI 模型。
