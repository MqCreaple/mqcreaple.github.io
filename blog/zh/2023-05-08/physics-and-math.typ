...
#strike[几个月没写东西，现在感觉不会中文了]

事情大概是这样的，今天下午在同学们办的 AP 物理复习讨论里面被整崩溃了。在讨论电磁学题目的时候，我发现了大部分同学其实并不理解他们用到的公式背后的原理。比如，有些人不清楚感应电动势的公式 $ cal(E) = (dif Phi_B)/(dif t) $ 其实包含动生电动势 $ cal(E) = B (dif S)/(dif t) $ 和感生电动势 $ cal(E) = S (dif B)/(dif t) $ 这两个背后原理完全不同的成分；有些人不清楚 Biot-Savart 定律和安培环路定律其实都在描述“电流产生磁场”这同一件事。其他的例子也不多举了，总之，大多数人能背下来电磁学公式表上的绝大部分公式，教科书上的模板题目也知道解法，但是公式背后的原理和理论却并不了解。

之后，我开始思考如何向大家解释这些公式的含义，如何用更基本的定理（麦克斯韦方程）来串起来这一系列公式。与此同时，我也在思考，当时我是怎么学会电磁学的？我又是如何掌握这一系列知识的？

大概在六年级还是初一的时候，我最早接触到了高中的电磁学知识。那时我的确也是先从库仑定律、安培定律、安培力、楞次定律等一堆散乱而看似毫无关联的定理开始学起的。而在初二开始学习物理竞赛的时候，我学会了矢量运算和微积分这两大工具，也接触到了更多、更杂乱的电磁学定律，像是高斯定理、安培环路定理、Biot-Savart 定律等等，这些使用微积分描述电磁场的定律。当时我对电磁学的印象就是：_这东西太杂了、太难了_。

而我甚至不记得我是什么时候学了散度、旋度等矢量场的运算，在之后又是什么时候学了麦克斯韦方程。但是在最开始接触麦克斯韦方程的时候，我只是将它当作“电磁学定律大家族”中的一个。后来，我做了更多的物理题并且思考了更多的物理问题之后，我才逐渐意识到，_麦克斯韦的四个方程再加上 $ arrow(F) = q (arrow(E) + arrow(v) times arrow(B)) $，总共5个方程，就可以用来解释剩下所有的定律_。其他的定律要么和这五个方程中的某个等价，要么就是在描述麦克斯韦方程的某个特殊情况。在那时，我有一种“大彻大悟”的感觉，我觉得自己已经掌握了电磁学的本质。

可能大概就是从那时开始，我就喜欢上了那种_掌握世界本质_的感觉，换句话说就是_从细化的规律中抽象出更本质的规律_（这可能也是大多数物理学生的想法吧）。这也进一步激励我继续学习物理和数学。在数学里，我也曾经有过类似的感觉，比如在最开始接触到群论、线性代数和一些简单的拓扑的时候。群、线性空间和拓扑空间等数学概念都是提取了以前很多具象的数学概念（例如实数、复数、向量）的某些抽象性质，并基于这些性质建立更多的理论。
...
不同的学生可能对这两种思维方式有不同的偏好，有些可能更喜欢自上向下，而有些可能喜欢自下向上。不同的教师和教材也有这种思维方式上的不同，有些教材会先介绍许多特殊结论再介绍背后的原理，而有些教材会先讲原理再一步步推导出细化的结论。
