...
Since Peano curve is constructed by dividing the space into 1/3 of its original length, the curve's size must be a power of 3. To be able to put everything onto a square, it also requires the cube's side length to be a perfect square number. The largest number satisfying both requirements is 81. Thus, the color division shown in this image is not as finely comparing to the previous curves.
