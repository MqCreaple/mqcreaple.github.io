...
// summary: In the era of Mandarin, can dialects still be saved?
...
#image("chinese-dialect.svg", width: 70%)

_The approximation between dialects are from_ @cite3

Then, with the previous conjecture, since the influence of Cantonese and Shanghainese in your environment is less than the influence of Hangzhou dialect, also, these two languages is 'linguistically' farther away from Min dialect, then both languages are not worth learning compared to Hangzhou dialect. In this table, only 2 languages are worth of learning: _Hangzhou dialect_ and _Mandarin_.
...
- Morphological: forgetting the words and word formation of the first language, and replacing them with corresponding words in the second and third languages.
...
Although Longquanyi is only 30 kilometers away from the city center of Chengdu, the dialects in two places have many differences. Chengdu city and most rural areas around it speaks Chengdu dialect, which belongs to the *Southwestern Mandarin* branch of *Mandarin*. However, in Longquanyi, the most spoken dialect is the *Sichuan Hakka dialect* under the #link("https://en.wikipedia.org/wiki/Hakka_Chinese")[*Hakka* dialect], since most residents are Hakka people who came to Chengdu during #link("https://zh.wikipedia.org/wiki/%E6%B9%96%E5%B9%BF%E5%A1%AB%E5%9B%9B%E5%B7%9D")[湖广填四川 (the Great Migration from Hubei, Hunan, and Guangdong to Sichuan)]. In #link("https://zhongguoyuyan.cn/index/")[The Data Collection, Recording, and Display Platform for the Chinese Language Resources Protection Project], there is detailed introduction of the language. #link("https://zh.wikipedia.org/wiki/%E5%9B%9B%E5%B7%9D%E5%AE%A2%E5%AE%B6%E8%A9%B1")[Chinese Wikipedia] also have corresponding articles, so I won't introduce the language in too much detail.

#image("longquanyi-1.png", width: 70%)

_Location of Longquanyi_

#image("湖广会馆.jpg", width: 70%)

_湖广会馆 (hú guǎng huì guǎn, Hu-Guang Meeting House)：After the immigration, the meeting house is built as a social and meeting place for people from Hu-Guang area._

Longquanyi District is a Hakka #link("https://en.wikipedia.org/wiki/Language_island")[dialect island] in Sichuan. Due to the growing need for communication, most Longquanyi locals now speak two dialects - Hakka and Chengdu dialect, with increasing number of people who can speak Mandarin fluently. In the most famous scenic spot in Longquanyi - Luodai Ancient Town, almost all staff there can speak Mandarin, Chengdu dialect, and Hakka dialect due to inflow of tourists from all over the country. Therefore, it can be seen that near the tourist attractions, the three dialects are ranked in this order of influence: *Mandarin > Chengdu dialect > Sichuan Hakka*.

#image("洛带古镇.jpeg", width: 70%)

_洛带古镇 (luò dài gǔ zhèn, Luodai ancient town)_

Ever since the Hakka people moved to Longquanyi, their Hakka language has never stopped evolving. I interviewed some locals near tourist attractions and asked them how certain words are pronounced in their local dialects. I recorded the conversations with the interviewees' consent. The results are shown in the following table, compared with the pronunciation of Meixian Hakka dialect (the dialect in east Guangdong, usually set as the standard of Hakka dialect) given on #link("https://www.wiktionary.org/")[Wiktionary]:
...
Some other languages gained influence outside their native language area through the spread of literary and artistic works. For example, in China, Cantonese pop songs, movies and other artistic works during the 80s have a larger influence beyond Guangdong, Hong Kong, and Macau, making Cantonese a popular language in the literary and artistic circles.
...
Some people may compare language with species in biology, thinking that language diversity and ecodiversity can be protected in the same way, but the two concepts have completely different causes and evolutionary methods, and the two types of diversities have different impact on society.
...
Nowadays, influences of Mandarin to Chinese dialects are everywhere. Not many ways of protecting dialects are left. Obviously, force isolation of dialect speakers from the outside world is inhumane and contradictory to people's will and society's development. As for what else we can do, it depends on which side of the spectrum you fall on on the previous question.

If you align with the first opinion, then you would want to preserve a language by creating a detailed archive. In the past, when audio and video recordings are not invented, we could only record the text of a language by compiling dictionaries, but now we can also record more comprehensive information such as voice and videos. Today, language institutions around the world have established many such archives. For example, you can see the dialects of each city and each region in China in detail on the #link("https://zhongguoyuyan.cn/")[Chinese Language Resource Protection Project Recording and Display Platform]. As long as the archives of a language are detailed enough, people in later generations can relearn the language based on these archives.
