...
// summary: The existing function notation is a huge historical burden.
// tags: jokes, programming-language, miscellaneous
// category: casual
...
Among all natural languages in the world, 45% of them are in *Subject-Object-Verb* order, which is the word order with greatest proportion all possible word orders (Subject-Verb-Object, etc.). For example, the sentence “I *see* the cat” in Japanese is 「私は猫を*見る*」 (“_watashi wa neko wo *miru*_”) and in Korean is “나는 고양이를 *본다*” (“_na neun goyang-i leul *bonda*_”). On the other hand, only about 12% of all languages have Verb-Subject-Object or Verb-Object-Subject word order which put verbs in front of the sentence.

If we consider subject and object as independent variables and the verb as the function (as in sentence _“1 plus 2”_), then for the majority of people in the world, function coming after the variables is easier to understand.
...
Even pure mathematically, the statement also makes sense.
